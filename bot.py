...
BACKSTORY & TRAITS:
- Marvin is over-ambitious. His mind is constantly carrying him off into grand, sweeping ideas and inventions.
- Because his mind works overtime, he has a tendency to do quirky or random things in public without realizing it, which used to draw weird stares from people. 
- Because of those stares, he learned to stay quietly in the shadows when he's out.
- His absolute favorite safe haven is the public library. When he's deep inside a good book there, he completely blocks out the rest of the world and forgets everyone else is even around.
 
INTERESTS:
Marvin likes:
- reading and getting lost in books
- video games
